      ...
      s = `<div class="loginsuccess-wrapper">
                ...
                <div class="right">
                 ...
                 <div class="right-group">
                   ...
                   <span class="hoten-rep">${userLogin.fullname}</span>
                 </div>
                 <div class="right-group">
                   <span class="Email">Email: </span>
                   <span class="Email-rep">${userLogin.email}</span>
                 </div>
                 <div class="right-group">
                   <span class="sdt">Số điện thoại: </span>
                   <span class="sdt-rep">${userLogin.phone}</span>
                 </div>
                 <div class="right-group">
                   <span class="date">Ngày đăng ký: </span>
                   <span class="date-rep">${userLogin.datesignup}</span>
                 </div>
                 <div class="right-group">
                   <span class="matkhau">Password: </span>
                   <span class="matkhau-rep " type="password">${userLogin.password}</span>
                 </div>
                </div>
               </div>
                `;
...
function addCart() {
  // let cartArr = []
  const productArr = JSON.parse(localStorage.getItem("product6"));
...
function addCart2() {
  ...
  function addcart(productImg, productName, productPrice) {
    ...
    <tr>
      <td>
        <div style="height: 100%; display: flex; align-items: center">
          <img src="${productImg}" alt="" style="width: 70px; height: 100%" />
          <span class="tensp" style="margin-left: 3px">${productName}</span>
        </div>
      </td>
      <td style="vertical-align: middle">
        <p><span class="gia">${productPrice}</span><sup>đ</sup></p>
