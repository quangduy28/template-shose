        ...
        <div class="product-right">
          ...
          <div class="product-page">
            <ul class="product-page-list">
              <li class="product-btn-prev btn-active fas fa-angle-left"></li>
              <div class="product-number-page" id="product-number-page">
              <!--  <li class="product-active product-number-item">
                            <a>1</a>
                        </li>
                        <li class="product-number-item">
                            <a>2</a>
                        </li>
                        <li class="product-number-item">
                            <a>3</a>
              ...
              <li class="product-btn-next fas fa-angle-right"></li>
            </ul>
          </div>
        </div>
      </div>
