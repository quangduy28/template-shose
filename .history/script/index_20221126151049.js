...
function createProduct() {
    if(localStorage.getItem('product6') === null) {
        let product = [
            ...
            { image: "./images/img/nike20.jpg" , price: "1000000", 
            name: "Nike Air Force 1 Low Retro" 
            },
            { image: "./images/img/nike21.jpg" , price: "1500000", 
            name: "Jordan Series" 
            },
            { image: "./images/img/nike22.jpg" , price: "4500000", 
            name: "Nike Air Zoom Alphafly" 
            },
            { image: "./images/img/nike23.jpg" , price: "3250000", 
            name: "Nike Air Presto" 
            },
            { image: "./images/img/nike24.jpg" , price: "3200000", 
            name: "Air Jordan 1 Low SE" 
            },
            { image: "./images/img/nike25.jpg" , price: "2200000", 
            name: "Nike Zoom Mercurial" 
            },
            { image: "./images/img/nike26.jpg" , price: "5300000", 
            name: "Air Jordan XXXVII PF" 
            },
            { image: "./images/img/nike27.jpg" , price: "5100000", 
            name: "Air Jordan 1 Zoom CMFT"
            },
            { image: "./images/img/nike28.jpg" , price: "2300000", 
            name: "Air Jordan 1 Mid SE"
            },
            { image: "./images/img/nike29.jpg" , price: "3300000", 
            name: "Jordan 1 KO"
            },
            { image: "./images/img/nike30.jpg" , price: "1300000", 
            name: "Nike Oneonta"
            },
            { image: "./images/img/nike31.jpg" , price: "3200000", 
            name: "Nike Pegasus Turbo Next Nature"
            },
            { image: "./images/img/nike32.jpg" , price: "5500000", 
            name: "Air Jordan 6 Retro"
            },
            { image: "./images/img/nike33.jpg" , price: "4400000", 
            name: "Air Jordan 5 Retro"
            },
            { image: "./images/img/nike34.jpg" , price: "2700000", 
            name: "Nike Dunk Low SE"
            },
            { image: "./images/img/nike35.jpg" , price: "3800000", 
            name: "Nike Air Trainer 1"
            },
            { image: "./images/img/nike36.jpg" , price: "3200000", 
            name: "Nike Air Trainer 2"
            },
            { image: "./images/img/nike37.jpg" , price: "4500000", 
            name: "Nike ACG Mountain Fly Low SE"
            },
            { image: "./images/img/nike38.jpg" , price: "6600000", 
            name: "Nike ZoomX Vaporfly NEXT"
            },
            { image: "./images/img/nike39.jpg" , price: "3800000", 
            name: "Nike Air Zoom Pegasus 39 A.I.R. Hola Lou"
            },
            { image: "./images/img/nike40.jpg" , price: "3500000", 
            name: "Nike Hyperdunk X EP"
            },
            { image: "./images/img/nike41.jpg" , price: "3500000", 
            name: "Nike SuperRep Cycle 2 Next Nature"
            },
            { image: "./images/img/nike42.jpg" , price: "7500000", 
            name: "Nike Zoom Mercurial Superfly 9 Elite KM FG"
            },
            { image: "./images/img/nike43.jpg" , price: "7500000", 
    ...
    function renderProduct1() {
        ...
        const content = product.map((item,index) => {
            if(index >= start && index < end) {
                s += `
                <div class="product-category-item" onclick="showProductDetail('${item.name}')">
                <img
                src="${item.image}"
                alt=""
                ...
                <div class="product-category-info">
                  ...
                  <span class="product-category-price">${currency(item.price)}</span>
                </div>
              </div>
                `;
                return s;
  ...
  let tmpArr = []
	...
	if(productsearch != "") {
		for(var i = 0; i < arrProduct.length; i++){
			if ((arrProduct[i].name.toLowerCase().search(productsearch) != -1 ) && productsearch != '') {
...
function showProductDetail (productname) {
  function currency(num) {
    ...
    btnThem.addEventListener("click", function (e) {
        const modal = e.target.parentNode.parentNode.parentNode.parentNode.parentNode;
        modal.parentNode.removeChild(modal);
    });
...
function createAdmin(){
	if(localStorage.getItem('user')===null){
        var userArray = [];
		var user = {email: 'admin@gmail.com', password: '12345678', fullname: 'ADMIN', phone: '0815147600' , datesignup: '20-11-2022'};
		userArray.push(user);
...
function createUser(e) {
    ...
    var user = {email: email.value, password: password.value, fullname: fullname, phone: phone.value , datesignup: datesignup};
      ...
      document.querySelector('.error-login-pass').style.display = 'block';
        ...
        if (password.length < 8) {
          ...
          document.querySelector('.error-login-pass').style.display = 'none';
            document.getElementById('password-login').style.border = '1px solid #e5e5e5';
        }
	if(flag==true){
		return false;
	}
  ...
  for(var i = 0 ; i < cartItem.length ; i++){
   ...
   productT[i].addEventListener("click",function(e){
    ...
    for(var i = 0 ; i < productarr.length; i++){
      ...
      if(productarr[i].name == namedelete2 && productarr[i].name == cartArr[j].name){
          cartArr.splice(j,1);
          changeIcon()
      }
    }
...
function buy(){
	...
	var info = '';
	var totalprice = 0;
	if(localStorage.getItem('cart')===null || localStorage.getItem('cart')=='[]' || document.querySelectorAll('tbody tr').length == 0){
  ...
  for (var i = 0; i < billArray.length; i++) {
    if(user.fullname==billArray[i].customer.fullname){
      ...
      s+='<div class="billcontent">'+
        '<div class="billcontent-name">'+billArray[i].info+'</div>'+
        '<div class="billcontent-price" style="color: #666;">'+(billArray[i].totalprice).toLocaleString('de-DE')+'đ'+''+'</div>'+
        '<div class="billcontent-date" style="color:#666">'+billArray[i].date+'</div>'+
        '<div class="billcontent-status">'+billArray[i].status+'</div>'+
      '</div>';
    }
  }
